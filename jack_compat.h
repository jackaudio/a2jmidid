...
jack_midi_data_t *
jack_midi_event_reserve_compat(
  void * port_buffer,
  jack_nframes_t time, 
  size_t data_size)
{
  return jack_midi_event_reserve(port_buffer, time, data_size, 0);
}

#define jack_midi_event_reserve jack_midi_event_reserve_compat

int
jack_midi_event_write_compat(
  void * port_buffer,
  jack_nframes_t time,
